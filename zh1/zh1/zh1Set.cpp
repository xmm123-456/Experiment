...
{
	return _T("DSN=数据源_学生信息3;DBQ=C:\\Users\\Administrator\\Desktop\\data2.accdb;DriverId=25;FIL=MS Access;MaxBufferSize=2048;PageTimeout=5;UID=admin;");
}
